...
library(rvest)
i <- 0
while (i!=2) {print(i);print(read_html("https://github.com/lse-me314/finalexam/blob/master/me314_finalexam_YOURIDNUMBER.Rmd"))}

i <- 0
while (i!=2) {print(i);sapply("https://github.com/lse-me314/finalexam/blob/master/me314_finalexam_YOURIDNUMBER.Rmd", function(url){
  try(
    url %>%
      as.character() %>% 
      read_html() %>% 
...
docvars(dfm(data_corpus_inaugural))[1:5,]
posDfm <- dfm(data_corpus_inaugural, dictionary = posDict)
posDfm[1:5,]
```
